...
class TestBuiltinsFromDSLAssembler: public TestBuiltinsAssembler {
 public:
  ...
  void LabelTestHelper1(Label* label_Label1_497);
  void LabelTestHelper2(Label* label_Label2_498, TVariable<Smi>* Label20_343);
  void LabelTestHelper3(Label* label_Label3_499, TVariable<String>* Label30_344, TVariable<Smi>* Label31_345);
  void TestConstexpr1();
  ...
  void LabelTestHelper4(bool p_flag, Label* label_Label4_533, Label* label_Label5_534);
  ...
  TNode<Object> GenericMacroTestWithLabels22UT12ATHeapObject5ATSmi(TNode<Object> p_param2, Label* label_Y_542);
  ...
  TNode<Object> GenericMacroTestWithLabels5ATSmi(TNode<Smi> p_param, Label* label_X_1014);
