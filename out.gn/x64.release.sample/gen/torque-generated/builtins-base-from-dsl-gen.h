...
class BaseBuiltinsFromDSLAssembler: public CodeStubAssembler {
 public:
  ...
  TNode<Object> LoadElementNoHole12ATFixedArray(TNode<JSArray> p_a, TNode<Smi> p_index, Label* label_IfHole_11);
  TNode<Object> LoadElementNoHole18ATFixedDoubleArray(TNode<JSArray> p_a, TNode<Smi> p_index, Label* label_IfHole_15);
  TNode<BoolT> NumberIsNaN(TNode<Number> p_number);
  TNode<BoolT> ToBoolean(TNode<Object> p_obj);
  TNode<Number> ToIndex(TNode<Object> p_input, TNode<Context> p_context, Label* label_RangeError_20);
  ...
  TNode<FixedArray> cast12ATFixedArray(TNode<HeapObject> p_o, Label* label_CastError_964);
  TNode<FixedDoubleArray> cast18ATFixedDoubleArray(TNode<HeapObject> p_o, Label* label_CastError_966);
  TNode<JSArray> cast9ATJSArray(TNode<Object> p_o, Label* label_CastError_970);
  TNode<JSReceiver> cast45UT17ATJSBoundFunction12ATJSFunction9ATJSProxy(TNode<Object> p_o, Label* label_CastError_972);
  TNode<JSArray> cast9ATJSArray(TNode<HeapObject> p_o, Label* label_CastError_969);
  TNode<JSDataView> cast12ATJSDataView(TNode<Object> p_o, Label* label_CastError_1013);
  TNode<IntPtrT> convert8ATintptr(int31_t p_i);
  TNode<FixedArray> cast12ATFixedArray(TNode<Object> p_o, Label* label_CastError_965);
};
